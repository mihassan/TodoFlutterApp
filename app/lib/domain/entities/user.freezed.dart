...
/// Unique identifier from the auth provider (Firebase UID).
 String get uid;/// Email address (always present for email/password and Google sign-in).
 String get email;/// Display name if available (nullable).
 String? get displayName;/// URL to profile photo if available (nullable).
 String? get photoUrl;/// When the user account was created (UTC).
 DateTime get createdAt;/// When the user profile was last updated (UTC).
...
@override
String toString() {
  return 'User(uid: $uid, email: $email, displayName: $displayName, photoUrl: $photoUrl, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
/// Create a copy of User
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uid = null,Object? email = null,Object? displayName = freezed,Object? photoUrl = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
...
class _User implements User {
  const _User({required this.uid, required this.email, this.displayName, this.photoUrl, required this.createdAt, required this.updatedAt});
...
/// Create a copy of User
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uid = null,Object? email = null,Object? displayName = freezed,Object? photoUrl = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_User(
uid: null == uid ? _self.uid : uid // ignore: cast_nullable_to_non_nullable
as String,email: null == email ? _self.email : email // ignore: cast_nullable_to_non_nullable
as String,displayName: freezed == displayName ? _self.displayName : displayName // ignore: cast_nullable_to_non_nullable
